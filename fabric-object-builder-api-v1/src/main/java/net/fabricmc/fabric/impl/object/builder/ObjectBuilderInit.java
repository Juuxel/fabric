...
public final class ObjectBuilderInit implements ModInitializer {
	...
	public void onInitialize() {
		DynamicRegistries.registerSynced(FabricBoatType.REGISTRY_KEY, FabricBoatType.CODEC, FabricBoatType.NETWORK_CODEC, DynamicRegistrySyncOption.SKIP_WHEN_EMPTY);
	}
}
